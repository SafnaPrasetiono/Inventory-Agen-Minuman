    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <h2>
                    Pencarian <?php echo $ctg_search; ?>
                    <?php $sql_jum = $koneksi->query("SELECT * FROM barang WHERE nama_brg LIKE '%$ctg_search%'"); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 pull-right">
                        <div class="row">
                            ...
                            <?php $sql_data2 = $koneksi->query("SELECT * FROM barang WHERE nama_brg LIKE '%$ctg_search%'"); ?>
                                    ...
                                    <nav aria-label="page navigation">
                                        <ul class="pagination pull-right">
                                            <li>
                                                ...
                                                <?php if ($dt_halaman > 1) : ?>
                                                    <a href="index.php?set=pencarian&ctg_search=<?php echo $ctg_search ?>&halaman=<?php echo $halaman_sebelum ?>" aria-label="Previous">
                                            ...
                                            <li>
                                                ...
                                                <?php for ($i = 1; $i <= $hal; $i++) : $page = $i; ?>
                                                    <a href="index.php?set=pencarian&ctg_search=<?php echo $ctg_search ?>&halaman=<?php echo $page ?>">
                                                        <?php echo $i; ?>
                                                    </a>
                                                <?php endfor; ?>
                                            </li>
                                            <li>
                                                ...
                                                <?php if ($halaman_berikut <= $hal) : ?>
                                                    <a href="index.php?set=pencarian&ctg_search=<?php echo $ctg_search ?>&halaman=<?php echo $halaman_berikut ?>" aria-label="Next">
                    ...
                    <div class="hidden-xs col-xs-12 col-sm-3 col-md-3 col-lg-3 pull-left">
